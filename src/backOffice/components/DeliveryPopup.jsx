...
import { changeDeliveryCompleted, changeShipping } from "../../kkuda/reducers/publicData";
...
export default function DeliveryPopup({ setPopUp, checked, setChecked }) {
    ...
    const handleStatus = (e) => {
        ...
        if (deliveryStatus === "배송중") {
            for (const data in checked) {
                dispatch(changeShipping(checked[data]));
            }
            setChecked("");
        } else if (deliveryStatus === "배송완료") {
            for (const data in checked) {
                dispatch(changeDeliveryCompleted(checked[data]));
            }
            setChecked("");
        }
                ...
                <PopupBox>
                    ...
                    <div className="contentArea">
                        ...
                        <div className="radioBox">
                            <fieldset>
                                <input onChange={(e) => setDeliveryStatus(e.target.value)} value="배송중" type="radio" id="ing" name="deliverRadio"></input>
                                <label htmlFor="ing">
                                    {" "}
                                    <i></i> <span>배송중</span>{" "}
                                </label>
                            ...
                            <fieldset>
                                <input onChange={(e) => setDeliveryStatus(e.target.value)} value="배송완료" type="radio" id="done" name="deliverRadio"></input>
                                <label htmlFor="done">
                                    {" "}
                                    <i></i> <span>배송완료</span>{" "}
                                </label>
